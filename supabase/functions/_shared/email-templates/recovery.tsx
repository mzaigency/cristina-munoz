...
export const RecoveryEmail = ({ siteName, confirmationUrl }: Props) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Restablece tu contraseña de Glowapp</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          <Text style={badge}>Recuperar contraseña</Text>
          <Heading style={h1}>Restablece tu contraseña</Heading>
          <Text style={text}>
            Hemos recibido una solicitud para cambiar la contraseña de tu cuenta en{' '}
            <strong style={brand}>{siteName}</strong>. Pulsa el botón para crear una nueva.
          </Text>
          <Button style={button} href={confirmationUrl}>Crear nueva contraseña</Button>
          <Text style={muted}>El enlace expira en 1 hora.</Text>
          <Text style={footer}>
