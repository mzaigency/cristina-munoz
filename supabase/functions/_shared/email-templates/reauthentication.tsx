...
export const ReauthenticationEmail = ({ token }: Props) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Tu código de verificación de Glowapp</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          <Text style={badge}>Verificación</Text>
...
const code = { fontFamily: "'Courier New', monospace", fontSize: '32px', fontWeight: 800 as const, color: PRIMARY, letterSpacing: '0.2em', textAlign: 'center' as const, background: '#f5f6fa', borderRadius: '12px', padding: '18px', margin: '0 0 24px' }
const footer = { fontSize: '12px', color: '#9098a8', margin: '20px 0 0', lineHeight: 1.5 }
