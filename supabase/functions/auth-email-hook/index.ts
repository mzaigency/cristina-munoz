...
const SAMPLE_PROJECT_URL = "https://cristina-munoz.lovable.app"
...
const handler = createAuthEmailHandler({
  ...
  emails: {
    signup: {
      subject: '✨ Confirma tu cuenta de Glowapp',
      render: (data) =>
    ...
    invite: {
      subject: 'Te han invitado a Glowapp',
      render: (data) =>
    ...
    magiclink: {
      subject: 'Tu enlace para acceder a Glowapp',
      render: (data) =>
    ...
    email_change: {
      subject: 'Confirma tu nuevo email en Glowapp',
      render: (data) =>
    ...
    reauthentication: {
      subject: 'Tu código de verificación de Glowapp',
      render: (data) =>
