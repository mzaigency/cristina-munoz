...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-1/2 -translate-x-1/2 z-[100] flex flex-col items-center gap-2 pt-[calc(env(safe-area-inset-top)+12px)] px-4 w-full max-w-md pointer-events-none [&>*]:pointer-events-auto",
      className,
    )}
    {...props}
  />
