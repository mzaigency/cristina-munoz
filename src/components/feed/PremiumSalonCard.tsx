      ...
      <Link to={`/salon/${salon.slug}`} className="block">
        <div className="relative overflow-hidden rounded-[28px] bg-card border border-border/30 shadow-xl shadow-foreground/[0.03] transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-primary/15 group-hover:border-primary/30">
          ...
          <div className="relative h-52 overflow-hidden">
            ...
            {salon.avgRating !== null && (
              <motion.div
                ...
                className="absolute bottom-3.5 right-3.5 flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-black/95 backdrop-blur-sm shadow-xl"
              >
                <Star className="h-4 w-4 fill-amber-400 text-amber-400" />
                <span className="text-sm font-bold text-secondary-foreground">{salon.avgRating.toFixed(1)}</span>
          ...
          <div className="p-5">
            ...
            {salon.tagline && (
              <p className="text-sm text-muted-foreground mb-3 line-clamp-2 leading-relaxed">{salon.tagline}</p>
            )}
