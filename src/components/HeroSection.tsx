  ...
  return <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 py-20 text-center">
        <div className="mx-auto max-w-3xl space-y-8">
          <BlurText text={import.meta.env.VITE_BUSINESS_NAME} className="font-bold tracking-tight font-playfair text-[#3b2b30] text-5xl md:text-7xl" delay={150} animateBy="words" direction="top" />

          <p className="text-base text-[#737d8c] md:text-lg font-normal">
