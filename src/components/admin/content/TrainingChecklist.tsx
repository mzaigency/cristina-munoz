...
const TRAINING_STEPS: TrainingStep[] = [
  {
    ...
    icon: <Scissors className="h-5 w-5"/>, navigateTo:"catalog",
    subTab: "services",
  ...
  },
  {
    ...
    icon: <Calendar className="h-5 w-5"/>, navigateTo:"agenda",
  },
  {
    id: "cash_register",
    title: "Realiza tu primer cobro",
    description: "Aprende a usar la caja registradora",
    icon: <CreditCard className="h-5 w-5"/>, navigateTo:"agenda",
    subTab: "cash",
  ...
  },
  {
    ...
    icon: <MessageCircle className="h-5 w-5"/>, navigateTo:"clients",
    subTab: "messages",
  ...
  },
  {
    ...
    icon: <ImagePlus className="h-5 w-5"/>, navigateTo:"marketing",
    subTab: "posts",
  ...
  },
  {
    ...
    icon: <BarChart3 className="h-5 w-5"/>, navigateTo:"reports",
    subTab: "stats",
