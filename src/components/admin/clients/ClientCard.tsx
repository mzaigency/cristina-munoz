...
function getAvatarColor(name: string) {
  const colors = [
    "bg-[var(--gp-danger)]", "bg-[var(--gp-purple)]", "bg-[var(--gp-info)]", "bg-[var(--gp-ok)]",
    "bg-[var(--gp-warn)]", "bg-[var(--gp-info)]", "bg-[var(--gp-purple)]", "bg-[var(--gp-info)]",
  ];
  let hash = 0;
      ...
      >
        <div className="flex items-center gap-3">
          <div className="relative shrink-0">
            ...
            {client.user_id && (
              <div className="absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full bg-[var(--gp-ok)] flex items-center justify-center border-2 border-background">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 text-xs text-muted-foreground mt-0.5">
              ...
              <span className="font-medium text-[var(--gp-ok-ink)]">{(client.total_spent || 0).toFixed(0)}€</span>
