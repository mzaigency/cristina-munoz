...
const STEPS: TourStep[] = [
  ...
  },
  {
    id: "equipo",
    emoji: "👥",
    target: "equipo-personal",
    goto: { section: "equipo", subTab: "personal" },
    title: "Tu equipo y turnos",
    body: "Estilistas, cuadrante semanal, horarios y gestión de ausencias en un solo lugar.",
    tips: ["Ya casi está ✨"],
  },
  {
    id: "negocio",
    emoji: "💼",
    target: "negocio-estadisticas",
    goto: { section: "negocio", subTab: "estadisticas" },
    title: "Negocio y difusión",
    body: "Estadísticas avanzadas, objetivos, feed social y tarjetas QR para compartir.",
  },
  {
    id: "done",
    emoji: "🎉",
