    ...
    <section className="pt-12 pb-24 bg-gradient-to-b from-background via-muted/10 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-primary/20 card-elevated glass">
              ...
              <form onSubmit={handleSubmitReview} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    rows={5}
                    className="resize-none transition-all duration-300 focus:shadow-md"
                  />
                </div>

                <Button type="submit" className="w-full btn-shine" size="lg" disabled={submitting}>
