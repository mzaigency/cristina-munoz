  ...
  return <section className="py-24 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4">
        ...
        loop: true
          ...
          <CarouselContent>
            {placeData.reviews?.map((review, index) => <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
        ...
        <div className="max-w-2xl mx-auto mt-16">
          <Card className="border-primary/20 shadow-lg">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground text-center mb-6">Tu opinión es muy importante para nosotros.
La reseña es totalmente anónima</p>
              ...
              <form onSubmit={handleSubmitReview} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="comment" value={comment} onChange={e => setComment(e.target.value)} placeholder="Cuéntanos qué te ha gustado, qué mejorarías, o cualquier sugerencia..." rows={5} className="resize-none" />
                </div>
