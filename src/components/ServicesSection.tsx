...
const serviceCategories = [
  {
    ...
    image: cutService,
    services: [
      { name: "Corte chico", duration: "15 min" },
    ],
  },
  {
    category: "Coloración",
    ...
    services: [
      ...
      { name: "Mechas largas", duration: "3h" },
      { name: "Mechas cortas", duration: "1h 30min" },
  ...
  },
  {
    ...
    services: [
      { name: "Recogido", duration: "60 min" },
      { name: "Peinar con bucles", duration: "25 min" },
                ...
                <CardContent>
                  <div className="space-y-3">
                    {category.services.map((service, serviceIdx) => (
                      <div
                        key={serviceIdx}
                        className="flex items-center justify-between rounded-lg bg-salon-pink-light p-3"
                      >
