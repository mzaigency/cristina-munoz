...
export const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="py-20 bg-[hsl(230,20%,8%)]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-[hsl(230,10%,60%)] max-w-2xl mx-auto mb-8">
            Todos los planes incluyen 30 días de prueba gratis. Sin tarjeta requerida. Cancela cuando quieras.
          </p>

          {/* Billing toggle */}
          <div className="inline-flex items-center gap-3 p-1 rounded-full bg-[hsl(230,15%,14%)]">
            <span
              className={`text-sm px-3 py-1.5 rounded-full transition-colors ${!isAnnual ? "bg-[hsl(230,20%,20%)] text-white shadow-sm font-medium" : "text-[hsl(230,10%,50%)]"}`}
            >
              Mensual
            </span>
            ...
            <motion.div
              ...
              className={`relative rounded-2xl p-6 ${
                plan.popular
                  ...
                  : "bg-[hsl(230,15%,12%)] border border-[hsl(230,15%,18%)]"
              }`}
            >
              {plan.popular && (
              ...
              <div className="mb-6">
                <div
                  className={`w-10 h-10 rounded-xl bg-gradient-to-br ${plan.iconGradient} flex items-center justify-center mb-4`}
                >
              ...
              <div className="mb-6">
                ...
                <p className="text-xs mt-1 text-[hsl(230,10%,45%)]">
                  {isAnnual
                    ? `o ${plan.annualPrice}€/año (ahorra ${plan.annualSavings}€)`
                    : `o ${plan.annualPrice}€/año (ahorra ${plan.annualSavings}€)`}
                </p>
              </div>
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <div
                      className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${
                        plan.popular ? "bg-primary/20" : "bg-[hsl(230,15%,20%)]"
                      }`}
                    >
              ...
              <Button
                className={`w-full rounded-xl h-12 font-medium ${
                  plan.popular
                    ...
                    : "bg-[hsl(230,15%,18%)] hover:bg-[hsl(230,15%,22%)] text-white border border-[hsl(230,15%,25%)]"
                }`}
