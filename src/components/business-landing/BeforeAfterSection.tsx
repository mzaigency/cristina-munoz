...
const comparisons = [
  { before: "Agenda en papel o WhatsApp", after: "Calendario digital sincronizado" },
  { before: "No sabes cuánto facturas", after: "Analytics en tiempo real" },
  { before: "Clientes olvidan sus citas", after: "Recordatorios automáticos" },
  { before: "Sin presencia online", after: "Tu propia web profesional" },
  { before: "Pierdes clientes potenciales", after: "Reservas 24/7 automáticas" },
  { before: "Gestión manual del equipo", after: "Agenda por estilista" },
];
    ...
    <section className="py-20 bg-secondary/50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mt-2 mb-4 text-foreground">Antes vs Después</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden sm:block space-y-3">
            {comparisons.map((item, index) => (
              ...
              >
                <div className="p-4 rounded-xl bg-background border border-destructive/10 flex items-center gap-3">
