      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Si gestionas tu negocio con WhatsApp, llamadas y libretas... probablemente estés perdiendo tiempo y dinero cada día.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 max-w-6xl mx-auto">
          {painPoints.map((point, index) => (
            <motion.div
              ...
              className="group relative p-6 rounded-2xl bg-background border border-border hover:border-destructive/30 hover:shadow-lg transition-all duration-300"
            >
              ...
              <h3 className="font-semibold text-foreground mb-2 text-sm">{point.problem}</h3>
