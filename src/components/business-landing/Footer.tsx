      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mb-4">
              La plataforma todo-en-uno para profesionales de la belleza. 
              Reservas, agenda, pagos y marketing en un solo lugar.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:hola@glowapp.es" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  hola@glowapp.es
                </a>
              </li>
              <li>
                <a href="https://instagram.com/glowapp.es" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  @glowapp.es
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {currentYear} GlowApp. Todos los derechos reservados.
          </p>
