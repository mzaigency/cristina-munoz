...
const es = {
  ...
  "trust.openNow": "Abierto ahora",
  "trust.closedNow": "Cerrado ahora",
  "trust.closedToday": "Hoy cerrado",
...
const ca: Record<keyof typeof es, string> = {
  ...
  "trust.openNow": "Obert ara",
  "trust.closedNow": "Tancat ara",
  "trust.closedToday": "Avui tancat",
