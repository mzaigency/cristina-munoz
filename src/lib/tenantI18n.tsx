...
const es = {
  ...
  "gallery.eyebrow": "Trabajos",
  "gallery.titlePre": "Detrás del ",
  "gallery.titleAccent": "objetivo",
  ...
  "reviews.titlePre": "En las palabras de quienes ",
  "reviews.titleAccent": "nos visitan",
  ...
  "location.titlePre": "Te ",
  "location.titleAccent": "esperamos",
...
const ca: Record<keyof typeof es, string> = {
  ...
  "gallery.eyebrow": "Treballs",
  "gallery.titlePre": "Darrere de l'",
  "gallery.titleAccent": "objectiu",
  ...
  "reviews.eyebrow": "Testimonis",
  "reviews.titlePre": "En paraules de qui ",
  "reviews.titleAccent": "ens visita",
  ...
  "location.title": "Visita'ns",
  "location.titlePre": "T'",
  "location.titleAccent": "esperem",
