        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <Button 
                asChild 
                className="w-full h-11 md:h-12 rounded-xl font-bold text-sm md:text-base bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/25"
              >
                <Link to="/onboarding">Empezar gratis</Link>
              </Button>
            </motion.div>
